...
%% :- consult('/var/lib/myfrdcsa/codebases/minor/agentspeak-frdcsa/jason/environments/linux_remote_control_2/linux_remote_control_2.pl').

prolog_consult(File) :-
	consult(File).

:- consult('/var/lib/myfrdcsa/codebases/minor/formalog-pengines/formalog_pengines.pl').
:- start_agent(jasonLinuxRemoteControl).
...
%% /var/lib/myfrdcsa/collaborative/git/jason/examples/linux-remote-control-2-adapter/src/java/LinuxRemoteControl2AdapterEnv.java
