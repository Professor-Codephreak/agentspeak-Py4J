+!package(systemFn(Name,Version)) <-
	?existsDirType(binaryDirectory,systemFn(Name,Version));
...
+!sandbox(systemFn(Name,Version)) <-
	?existsDirType(sandboxDirectory,systemFn(Name,Version));
	?existsDirType(sandboxSubdirectory,systemFn(Name,Version));
...
+!debian(systemFn(Name,Version)) <-
	?existsDirType(debianDirectory,systemFn(Name,Version));
