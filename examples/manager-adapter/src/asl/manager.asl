...
{ include("/var/lib/myfrdcsa/collaborative/git/jason/examples/manager-adapter/src/asl/agent2.asl") }
{ include("/var/lib/myfrdcsa/collaborative/git/jason/examples/manager-adapter/src/asl/manager_agent.asl") }
